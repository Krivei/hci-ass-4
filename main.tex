...
\section{Research Question and Hypothesis}
  ...
  Cooking is an integral activity in daily life. Many household appliances can be used while doing this activity. A combination of appliances can be used in this activity, like sterilization, food preparation, and even serving. During this series of activities, users must shift their attention between activities while interacting with all the appliances simultaneously. That is why the distribution of attention and interaction in using appliances while cooking is considered very important. Without proper attention span while cooking, bad luck can happen all the time. Burnt food, overheating utensils, and even self-harm could happen because of minor things such as misplaced items or not paying attention. Understanding how attention and interaction work during cooking activity is very important for Human-Computer Interaction, as cooking represents a complex, real-world activity that combines physical action, cognitive decision-making, and time management. By examining cooking as an everyday practice, this research aims to understand how people naturally manage multiple technologies in their home environment.
  
  This study focuses on how each individual distributes their attention and interacts with appliances. Attention is understood as the mental focus at a given time, while interaction is more about how an individual can create engagement between appliances, such as cleaning, preparing a serving place, or responding to alerts. Rather than treating appliance use as isolated actions, this research views cooking as a dynamic process in which users continuously shift their focus in response to task demands, the appliance's response, and the current situation. Investigating these patterns can reveal how people prioritize tasks, manage interruptions, and coordinate actions across devices.   
  
  Building on this focus, the research question guiding this study is: “How do individuals distribute attention and interaction across household appliances during everyday cooking?” This is an exploratory qualitative study, in which we do not aim to test causal relationships but to identify recurring patterns and behaviors. Using Re-Enactment Video as our qualitative method in this study, we aim to understand how attention is evenly distributed across appliances and which factors shift someone’s attention, such as importance, timing, and perceived risk (e.g., burning food or spoiled broth). Similarly, interactions are expected to cluster around specific moments, such as preparation, checking progress, or responding to changes during cooking.  
  
  From the research question, several hypotheses are formulated to guide the analysis. First, users are expected to prioritize appliances that require constant attention, such as stovetops, over those that operate more autonomously, such as ovens or rice cookers. Second, attention shifts are expected to increase during moments of uncertainty or transition, like switching between cooking steps or multitasking. These hypotheses are important. They will guide in observation and analysis, rather than just predicting results. This observation and analysis also allows themes to emerge from the collected data

\section{Description of Approach and Considerations Taken}
...
\section{Documentation of Observations and Insights Gained}
...
\section{Critical Reflection and Conclusion}
...
\section{Reflection on Lessons Learned About Doing Observations}

The difficulties experienced by the observers vary depending on each individual. An evident problem discovered was the tendency for observers to put higher amount of attention to their writings instead of the queue as the size of the queue expands. After reviewing the notes, there was difficulty in identifying patterns due to the observers prioritizing the timestamps and group counts rather than information on behavioral details. Observers should put more balance to their focus to allow for more individual behavior observation. Self-reflection of each observer may also be helpful to decide on a more suitable method of observation.

Reviewing the notes revealed that while structural patterns, such as the transition from a horizontal line to an L-shaped queue once the queue size reaches a certain amount, were relatively easy to identify, the analysis of the reasoning behind the transition vary among the observers. This interpretation challenge suggests that detailed behavioral information, such as head orientation and the direction of field of vision, may be important to observe as it allows the observers to interpret the intention of the customers.

We had successfully obtained varieties of behaviours in each 30-minute session, but some information was shallow. Most observation notes were about what they were physically doing, but they were inadequate to determine insights about these specific actions done. For example, the men placed their hands in the pockets, while women had their purses placed in front of them. We were unable to infer as to why this was done. This showed that observation studies were not enough to understand consumers' behaviours.
