...
%% article.
\begin{abstract}
	Remote study provides an effective means of investigating everyday activities in natural settings. In this study, a re-enactment video was used to examine how individuals allocate attention and engage with kitchen appliances while cooking. Through participants’ demonstrations and verbal explanations, the method allowed detailed observation of cooking sequences and appliance use. Despite limitations, such as a limited field of view from the researcher’s perspective and a lack of context about the surrounding environment, the collected data still provided sufficient depth to capture recurring behaviors and attention shifts. The re-enactment video was later analyzed using qualitative thematic analysis to identify patterns in how participants coordinate actions and manage attention during cooking.
\end{abstract}
