...
During the re-enactment video process, we created very clear instructions for the individuals so they could understand the activity. When conducting the REV procedure, the key to a good result was how well individuals could describe the end goal and explain each activity. This was why pilot testing was crucial: for observers to know what they were trying to accomplish and how to create the environment for the re-enactment video to be conducted, both in online and offline sessions. By conducting a pilot test, we could see that many simple activities that we did not realize were important could have a big impact on later steps of analysis. By explaining every step individuals took, analysis could be conducted without requiring observers to interpret some steps ambiguously. Although there were sometimes limitations, such as limited fields of view during online conferences or the inability of observers to move freely to follow individuals due to privacy concerns, as long as the individuals were able to characterize their intentions, the data still served as a solid source for analysis.

During our coding session, we started by creating code groups. There were five colour groups used in the coding session. The first was yellow, which explained the kitchen preparation process. Activities in this group involved preparing utensils and ingredients, such as retrieving them from other places and placing them around the kitchen. The second colour was green, which explained the ingredient preparation process, describing how ingredients already present in the kitchen were prepared, such as chopping and peeling. In this group, we did not include activities such as cleaning ingredients or those related to heating and cooking. The third colour was blue, which represented the clean-up process. This process included cleaning ingredients and utensils. The fourth group was red, which described the cooking process. In the red colour group, all activities related to the stove and heat were stored. The last group colour was purple, which described the after-meal process, consisting of a series of activities performed after eating and cleaning the dishes.

When we finished assigning each activity to the encoding groups, we then continued by assigning labels to each encoding. During the labeling session, we focused on the question, “What did they do?” This question helped us understand the intention behind each activity they conducted. It also helped us describe each code more clearly, which we later used as a basis for identifying patterns.

After we finished encoding the results of the REV session using colours, we continued to identify patterns that had already formed from the labeling process. The patterns identified in this session were interesting, as some showed clear relationships with others. We observed that some individuals preferred to prepare everything in advance to avoid errors during cooking, while others tended to prepare actively during cooking to maintain workflow. The main focus in this session was to compare each label assigned during coding and to identify correlations with other labels. Once the labels were grouped, the next step was to assign a name to each group. In this session alone, we identified 16 pattern groups. Some of these groups correlated with one another, which later allowed us to form larger theme groups from these related patterns.

After identifying the patterns, we focused on understanding the relationships between them, which later informed the construction of themes. The goal of theme construction was to recognize each encoding and label so that we could identify findings and understand how attention was distributed and how interactions between appliances affected behavior during cooking. Multiple rounds of trial and error were conducted across several iterations to create themes that were clear and understandable. These iterative processes also helped us define the themes by providing short descriptions for each, making the motivation behind each theme easier to understand and ensuring that themes did not overlap with one another.
