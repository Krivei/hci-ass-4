...
%% article.
\begin{abstract}
	Cooking is a complex activity that requires people to coordinate multiple kitchen appliances while managing time, safety, and task demands in their personal space. Understanding how attention is distributed during cooking is important for Human-Computer Interaction, as breakdowns in attention can lead to errors or unsafe situations. In the current study, which uses a remote study approach, we use a re-enactment video to capture participants’ demonstrations. and verbal explanations of their cooking routines in their own kitchens. This method allowed detailed observation of cooking sequences, the appliances they used, and the moment when they switched their focus to other tasks, such as taking utensils, preparing ingredients, and cleaning. Despite limitations such as a restricted field of view and limited contextual information about the surrounding environment, the collected data provided sufficient depth to identify recurring behaviors and attention patterns. Qualitative thematic analysis was later used to understand the results of the observation, including how participants coordinate actions across appliances, manage transitions between tasks, and maintain awareness during cooking. These findings contribute to a better understanding of attention management in everyday cooking activity and provide insights for designing interactive systems that better support users in multi-appliance environments.
\end{abstract}
